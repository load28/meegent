...
const DESCRIPTION = [
  ...
  "*** End Patch",
  "",
  "Ops: `replace N..M:`, `insert before|after N:`, `insert head|tail:`, `delete N..M`. You may also",
  "target a whole brace/indentation block by its opening line: `replace block N:` / `delete block N`",
  "(no end line needed). Body rows are ONLY `+TEXT` (the final content, verbatim; `+` alone = blank line; `++x`/`+-x` to",
